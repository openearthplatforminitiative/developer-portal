...
export const Resources: Resource[] = [
	...
	},
	{
		...
		abstract: "Summary of agriculture relevant data from other OpenEPI APIs",
		icon: "agriculture",
		html_content:
			"<h3>Data sources</h3><p>This API aggregates data from our other agriculture relevant APIs .  Specifically it provides summerized data from the OpenEPI Deforestation API,OpenEPI Flood Forecast API, OpenEPI SoilGrids API and Location Weather Forecast API.</p>",
		documentation_url: "",
		download_url: "",
		git_url: "https://github.com/openearthplatforminitiative/agriculture-api",
		data_hub_url: "",
		research_paper_url: "",
		api_authentication_url: "",
		openapi_url: "https://api.openepi.io/agriculture/redoc",
		client_library: false,
		maintenance_and_update_frequency: "",
		spatial_extent: [],
		temporal_extent: [],
		contact: "",
		keywords: ["Deforestation", "Flood", "Soil", "Weather"],
		version: "",
		type: "API",
		categories: [
			{
		...
		code_examples: [],
		license: {
			id: "9948e696-029b-484d-bd68-e0f4914dbdfc",
			name: "Apache-2.0",
	...
	},
	{
		...
		code_examples: [
			{
				id: "a47e9904-f1c5-4ec8-aa4c-6997b327863b",
				title: "Get predictions with Binary",
				description: "Health predictions by the Binary model",
				code: [
					{
						id: "a6af56c9-2bf9-49e6-ae5d-84a454420e8b",
						language: "python",
						source:
					...
					{
						id: "f7d2f6de-89a0-4758-a27a-25e0cff6b32b",
						language: "java",
						source:
					...
					{
						id: "41b744fe-9146-40cc-ae04-8ca177ac3723",
						language: "javascript",
						source:
			...
			{
				id: "a92f9fba-b18d-4996-add2-203dc6acd224",
				title: "Get predictions with SingleHLT",
				description: "Health predictions by the SingleHLT model",
				code: [
					{
						id: "29720956-c039-45c5-b49d-b7f07f00ad34",
						language: "python",
						source:
					...
					{
						id: "9e09072a-5d5e-4766-89f3-fb52bb66219e",
						language: "java",
						source:
					...
					{
						id: "487a23ac-1adb-4266-b135-91e6c26f3cf0",
						language: "javascript",
						source:
							"import { CropHealthClient } from 'openepi-client';\nimport * as fs from 'fs';\nconst image = fs.readFileSync('./cocoa.jpg');\n\nconst client = new CropHealthClient();\nclient.getSingleHLTPrediction(image).then((result) => {\n  const { data, error } = result;\n  if (error) {\n    console.error(error);\n  } else {\n    console.log(data);\n  }\n});",
						created_by: "sander@kroglid.com",
					},
				],
				created_by: "sander@kroglid.com",
			...
			{
				id: "fa09eb28-30de-4f91-b70e-300ca94a3589",
				title: "Get predictions with MultiHLT",
				description: "Health predictions by the MultiHLT model",
				code: [
					{
						id: "890f4594-c10d-4e5f-bb8a-d1bd2c535367",
						language: "python",
						source:
					...
					{
						id: "bb9749f4-ca64-4642-bd15-1238ee1149ca",
						language: "java",
						source:
					...
					{
						id: "5df19b51-41ae-4195-a6da-aadd18c923ce",
						language: "javascript",
						source:
							"import { CropHealthClient } from 'openepi-client';\nimport * as fs from 'fs';\nconst image = fs.readFileSync('./cocoa.jpg');\n\nconst client = new CropHealthClient();\nclient.getMultiHLTPrediction(image).then((result) => {\n  const { data, error } = result;\n  if (error) {\n    console.error(error);\n  } else {\n    console.log(data);\n  }\n});",
						created_by: "sander@kroglid.com",
					},
				],
				created_by: "sander@kroglid.com",
	...
	},
	{
		...
		icon: "forest",
		html_content:
			'<h3>Data sources</h3>\n<p>\n  The deforestation data covers the period from 2001 to 2022 and is provided by\n  the\n  <a href="https://glad.umd.edu/" target="_blank"\n    >Global Land Analysis and Discovery (GLAD)</a\n  >\n  laboratory at the University of Maryland, in partnership with\n  <a href="https://www.globalforestwatch.org/" target="_blank"\n    >Global Forest Watch (GFW)</a\n  >. The data are freely available for use under a\n  <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank"\n    >Creative Commons Attribution 4.0 International License</a\n  >. River basin polygons data is provided by\n  <a href="https://www.hydrosheds.org/products/hydrobasins" target="_blank"\n    >HydroSHEDS</a\n  >. The basin data are freely available for both non-commercial and commercial\n  use under a licence agreement included in the\n  <a\n    href="https://data.hydrosheds.org/file/technical-documentation/HydroSHEDS_TechDoc_v1_4.pdf"\n    target="_blank"\n    >HydroSHEDS Technical Documentation</a\n  >.\n</p>\n<h3>Processing</h3>\n<p>\n  Using the river basin polygons, the deforestation data are aggregated per\n  basin and year.\n</p>',
		documentation_url: "https://glad.umd.edu",
		download_url: "",
		git_url: "https://github.com/openearthplatforminitiative/deforestation-api",
		data_hub_url: "",
		research_paper_url: "",
		api_authentication_url: "",
		openapi_url: "https://api.openepi.io/deforestation/redoc",
		client_library: true,
		maintenance_and_update_frequency: "Every 16 days",
		spatial_extent: [
			{
				id: "024f5c73-1bf6-4ad3-960e-9250fa575db9",
				type: "GLOBAL",
				spatial_resolution: "0.00025° x 0.00025°",
				created_by: "sander@kroglid.com",
			},
		],
		temporal_extent: [],
		...
		code_examples: [
			{
				id: "bdb5fe77-f2ee-494e-aebe-2bc1a22ce604",
				title: "Get yearly forest cover loss within a river basin",
				description:
					"Returns the estimated deforested area per year within a river basin for the given location",
				code: [
					{
						id: "c59c86c9-684a-4e92-be82-f99417cb85f4",
						language: "python",
						source:
					...
					{
						id: "0fbc5222-825d-443f-866f-dc6efb112f1f",
						language: "java",
						source:
					...
					{
						id: "9d542933-35d0-4df9-bc74-c8a88417e6a2",
						language: "javascript",
						source:
	...
	},
	{
		...
		icon: "e911_emergency",
		html_content:
			'<h3>Data sources</h3>\n<p>\n  Part of the data for this Flood API consists of the 30-day forecasted river discharge data retrieved on a daily basis from the Copernicus \n  <a href="https://cds.climate.copernicus.eu/cdsapp#!/dataset/cems-glofas-forecast?tab=overview" target="_blank">\n    Climate Data Store (CDS)\n  </a>. \n  Upstream area data was retrieved from the \n  <a href="https://confluence.ecmwf.int/display/CEMS/Auxiliary+Data#AuxiliaryData-GloFASAuxiliaryData" target="_blank">\n    auxiliary data page\n  </a> \n  of the Copernicus Emergency Management Service (CEMS). Additionally, return period threshold data was obtained directly from the GloFAS team, \n  but this will soon be made available through the CDS as well. All the data is on a global scale with resolution 5° by 5°. \n  Please note that these datasets are licensed under the \n  <a href="https://www.globalfloods.eu/terms-of-service/" target="_blank">\n    CEMS-FLOODS datasets licence\n  </a>, \n  which is not a standard open license. We use them in our pre-project to explore relevant data.\n</p>\n\n<h3>Processing</h3>\n<p>\n  The forecasted river discharge data is processed in order to obtain the summary and detailed forecasts. \n  The summary forecast corresponds to the GloFAS \n  <a href="https://confluence.ecmwf.int/display/CEMS/GloFAS+Reporting+Points" target="_blank">\n    Reporting Point\n  </a> \n  structure, which defines a flood\'s intensity, tendency, and peak timing over the 30-day forecast horizon for each grid cell. \n  In GloFAS, each reporting point is associated with a discharge hydrograph, which makes up the detailed forecast provided by the API. \n  The detailed forecast provides, for each day of the forecast horizon, values such as the five-number summary of the discharge distribution, \n  as well as the probabilities of exceeding the 2-, 5-, and 20-year return period thresholds.\n</p>\n<p>\n  In our processing pipeline, we first determine the detailed forecast by computing simple statistics at each day of the forecasted discharge data, \n  making use of the GloFAS return period threshold data. Then, we compute the summary forecast by aggregating the detailed forecast data over the forecast horizon. \n  Similarly to GloFAS, the upstream area data is used to filter out grid cells that have an upstream area smaller than 250 km<',
		documentation_url: "https://global-flood.emergency.copernicus.eu",
		download_url: "",
		git_url: "https://github.com/openearthplatforminitiative/flood-api",
		data_hub_url: "",
		research_paper_url: "",
		api_authentication_url: "",
		openapi_url: "https://api.openepi.io/flood/redoc",
		client_library: true,
		maintenance_and_update_frequency: "Daily",
		spatial_extent: [
			{
				id: "f3a5fd6c-80a6-47f7-ab95-82bb3d38be78",
				type: "REGION",
				region: "Africa",
				details: "Western, Central and Eastern Africa",
				geometry: {
					type: "FeatureCollection",
					features: [
						{
		...
		code_examples: [
			{
				id: "3d3a8b72-1bb9-4128-aff2-ad9c7a70e5fe",
				title: "Get return period thresholds for a location",
				description:
				...
				code: [
					{
						id: "318ebe31-46ec-433d-96ae-1ea4f5cc9285",
						language: "python",
						source:
					...
					{
						id: "80af1a36-8361-433b-87f0-d6025715fab8",
						language: "java",
						source:
					...
					{
						id: "a2a6a40e-b2e9-48a8-9223-e5e8cfeaaca5",
						language: "javascript",
						source:
							"import { FloodClient } from 'openepi-client';\n\nconst client = new FloodClient();\n\nclient.getThresholds({ lon: 22.260536, lat: 4.882569 }).then((result) => {\n  const { data, error } = result;\n  if (error) {\n    console.error(error);\n  } else {\n    console.log(data);\n  }\n});",
						created_by: "sander@kroglid.com",
					},
				],
				created_by: "sander@kroglid.com",
			...
			{
				id: "e079dfa8-c53b-4071-a2d6-7e9bc2c3394c",
				title: "Get detailed forecast for a location",
				description:
				...
				code: [
					{
						id: "e1895664-4b90-4515-9623-be727f91a11d",
						language: "python",
						source:
					...
					{
						id: "73b1a7ef-2064-423d-9ffd-5c8236b2c455",
						language: "java",
						source:
					...
					{
						id: "d225436e-55ab-4e58-bf8e-8209f5be2bd9",
						language: "javascript",
						source:
							"import { FloodClient } from 'openepi-client';\n\nconst client = new FloodClient();\n\nclient.getDetailedForecast({ lon: 22.260536, lat: 4.882569 }).then((result) => {\n  const { data, error } = result;\n  if (error) {\n    console.error(error);\n  } else {\n    console.log(data);\n  }\n});",
						created_by: "sander@kroglid.com",
					},
				],
				created_by: "sander@kroglid.com",
			...
			{
				id: "e0edc5ae-20a5-4317-91c2-2d5544786257",
				title: "Get summary forecast for a location",
				description:
				...
				code: [
					{
						id: "7b98e033-a77d-4dc2-ae37-cb3245abafd8",
						language: "python",
						source:
					...
					{
						id: "df349be9-f026-4cf1-a33b-b7d4010543f4",
						language: "java",
						source:
					...
					{
						id: "989f1af1-f496-4dcb-8b49-8abccee59cf0",
						language: "javascript",
						source:
	...
	},
	{
		...
		abstract: "Geocoding and reverse-geocoding based on OpenStreetMap®-data",
		icon: "settings",
		html_content:
			'<h3>Data sources</h3>\n<p>The API is exclusively fetching data from <a href="https://photon.komoot.io" target="_blank">https://photon.komoot.io</a>. The service is based on <a href="https://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap®</a>\n  data, which is licensed under the\n  <a href="https://opendatacommons.org/licenses/odbl" target="_blank">Open Data Commons Open\n    Database License (ODbL)</a>\n  , by the \n  <a href="https://osmfoundation.org" target="_blank">OpenStreetMap Foundation (OSMF)</a>\n  .\n</p>\n<h3>Processing</h3>\n<p>The data obtained from <a href="https://photon.komoot.io" target="_blank">https://photon.komoot.io</a> is presented as is, without\n  any further processing or modification.</p>',
		documentation_url: "https://photon.komoot.io/",
		download_url: "",
		git_url: "https://github.com/openearthplatforminitiative/geocoder-api",
		data_hub_url: "",
		research_paper_url: "",
		api_authentication_url: "",
		openapi_url: "https://api.openepi.io/geocoding/redoc",
		client_library: true,
		maintenance_and_update_frequency: "",
		spatial_extent: [
			{
				id: "cb399d7c-303e-4a01-84a9-fc84517c5db1",
				type: "GLOBAL",
				spatial_resolution: "",
				created_by: "sander@kroglid.com",
			},
		...
		code_examples: [
			{
				id: "41dde95b-7591-468e-81a0-72df8cb1a299",
				title: "Geocoding",
				description:
					"Returns a GeoJSON FeatureCollection of places matching the search query",
				code: [
					{
						id: "82f95544-2f6f-4d9d-ac16-a1b721c0ff17",
						language: "python",
						source:
					...
					{
						id: "24307575-a2e9-403b-8034-4376d435df6b",
						language: "java",
						source:
					...
					{
						id: "dd974cec-f70e-488e-8726-6ebf7dd38ffd",
						language: "javascript",
						source:
			...
			{
				id: "8acf8c56-0afb-4869-a271-08b235d7ba07",
				title: "Reverse Geocoding",
				description:
					"Returns a GeoJSON FeatureCollection of places near the provided coordinate",
				code: [
					{
						id: "41d5af85-023d-4b56-88c3-59be05e84a79",
						language: "java",
						source:
					...
					{
						id: "6336573d-57a4-43e7-8e2b-611dbb316e6e",
						language: "python",
						source:
					...
					{
						id: "c257eaf0-3135-46c9-8c92-d81cf1d6288f",
						language: "javascript",
						source:
							"import { GeocoderClient } from 'openepi-client';\n\nconst client = new GeocoderClient();\n\nclient.getReverseGeocoding({ lon: 22.260536, lat: 4.882569 }).then((result) => {\n  const { data, error } = result;\n  if (error) {\n    console.error(error);\n  } else {\n    console.log(data);\n  }\n});",
						created_by: "sander@kroglid.com",
						updated_by: "sander@kroglid.com",
					},
				],
	...
	},
	{
		...
		icon: "agriculture",
		html_content:
			'<h3>Data sources</h3>\n<p>\n  The API is exclusively fetching data from ISRIC (International Soil Reference\n  and Information Centre) - World Soil Information\'s\n  <a href="https://files.isric.org/soilgrids/latest/data/" target="_blank"\n    >WebDAV functionality</a\n  >. The service uses\n  <a href="https://www.isric.org/explore/soilgrids" target="_blank"\n    >SoilGrids</a\n  >\n  data, which is licensed under the\n  <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank"\n    >CC BY 4.0</a\n  >\n  license. The data are available at 250 meter resolution.\n</p>\n<p>\n  The nature of the available soil data can be separated into two categories:\n  soil type and soil properties. Soil type data is categorical and represents\n  the dominant soil type at the queried location. The 30 available soil types\n  are: Acrisols, Albeluvisols, Alisols, Andosols, Arenosols, Calcisols,\n  Cambisols, Chernozems, Cryosols, Durisols, Ferralsols, Fluvisols, Gleysols,\n  Gypsisols, Histosols, Kastanozems, Leptosols, Lixisols, Luvisols, Nitisols,\n  Phaeozems, Planosols, Plinthosols, Podzols, Regosols, Solonchaks, Solonetz,\n  Stagnosols, Umbrisols, and Vertisols. More information about the soil types\n  can be found\n  <a\n    href="https://www.fao.org/soils-portal/data-hub/soil-classification/world-reference-base/en/"\n    target="_blank"\n    >here</a\n  >.\n</p>\n<p>\n  Soil property data is continuous and represents the value of a specific soil\n  property at the queried location and depth. The available soil properties are:\n  Bulk density (bdod), Cation exchange capacity (cec), Coarse fragments (cfvo),\n  Clay (clay), Nitrogen (nitrogen), Organic carbon density (ocd), Organic carbon\n  stocks (ocs), pH water (phh2o), Sand (sand), Silt (silt), and Soil organic\n  carbon (soc). The available depths are: 0-5cm, 5-15cm, 15-30cm, 30-60cm,\n  60-100cm, 100-200cm, and 0-30cm (the ocs property is only available for the\n  0-30cm depth and vice versa.) The available values are: mean, 0.05 quantile,\n  median, 0.95 quantile, and uncertainty.\n</p>\n<p>\n  For more information about the data, please visit the\n  <a\n    href="https://www.isric.org/explore/soilgrids/faq-soilgrids"\n    target="_blank"\n    >SoilGrids FAQ</a\n  >.\n</p>\n<h3>Processing</h3>\n<p>\n  The data is retrieved from the ISRIC WebDAV service through various raster\n  files and processed to be served through the API. For example, soil types are\n  mapped from integer values to the corresponding soil type names, and the units\n  of the soil properties are added to responses. Additionally, some aggregation\n  is performed to produce a summary of the soil types, which, given a bounding\n  box, provides a mapping of each soil type to its number of occurrences in the\n  bounding box.\n</p>',
		documentation_url: "https://www.isric.org/explore/soilgrids",
		download_url: "",
		git_url: "https://github.com/openearthplatforminitiative/soil-api",
		data_hub_url: "",
		research_paper_url: "",
		api_authentication_url: "",
		openapi_url: "https://api.openepi.io/soil/redoc",
		client_library: true,
		maintenance_and_update_frequency: "",
		spatial_extent: [
			{
				id: "95bb6860-f084-4ee3-abd3-1730defdb91b",
				type: "GLOBAL",
				spatial_resolution: "250m x 250m",
				created_by: "sander@kroglid.com",
			},
		...
		code_examples: [
			{
				id: "686cff56-ebe3-470a-8368-8deb5d4083a4",
				title: "Get soil property",
				description:
				...
				code: [
					{
						id: "097c3911-b339-4047-b989-a7c8ede31a15",
						language: "python",
						source:
					...
					{
						id: "a4089e64-7d86-46e6-bb70-2a9349274cf3",
						language: "java",
						source:
					...
					{
						id: "6eb1d586-3b1c-4ccc-9cd0-91dbb911326a",
						language: "javascript",
						source:
							'import { SoilClient } from \'openepi-client\';\n\nconst client = new SoilClient();\n\nclient.getSoilProperty({ lon: 9.58, lat: 60.1, depths: "0-5cm", properties: ["bdod"], values: "mean" }).then((result) => {\n  const { data, error } = result;\n  if (error) {\n    console.error(error);\n  } else {\n    console.log(data);\n  }\n});',
						created_by: "sander@kroglid.com",
					},
				],
				created_by: "sander@kroglid.com",
			...
			{
				id: "7e1e9a74-bb72-4973-9071-d01c428bb702",
				title: "Get soil type",
				description:
					"Returns the most probable soil type for the given location",
				code: [
					{
						id: "99d91c07-0fbd-48fe-889e-ba45b0386c07",
						language: "python",
						source:
					...
					{
						id: "cf0ce6f8-99a5-48d2-9233-e2c2d6cb95c3",
						language: "java",
						source:
					...
					{
						id: "746c18a8-1d15-42b2-89ab-084a6e82cf4f",
						language: "javascript",
						source:
			...
			{
				id: "e6b7f2ba-53d6-4292-8c3b-ce40187f0bac",
				title: "Get soil type summary",
				description:
				...
				code: [
					{
						id: "546075fe-9130-49ca-a8dd-d2c5941470b6",
						language: "python",
						source:
					...
					{
						id: "051790e2-3c75-4a4b-80ee-223389cf2dc5",
						language: "java",
						source:
					...
					{
						id: "11238399-b2bf-438a-9b40-c19023797407",
						language: "javascript",
						source:
							"import { SoilClient } from 'openepi-client';\n\nconst client = new SoilClient();\n\nclient.getSoilTypeSummary({ min_lon: 9.58, max_lon: 10.58, min_lat: 60.1, max_lat: 62.1 }).then((result) => {\n  const { data, error } = result;\n  if (error) {\n    console.error(error);\n  } else {\n    console.log(data);\n  }\n});",
						created_by: "sander@kroglid.com",
					},
				],
				created_by: "sander@kroglid.com",
