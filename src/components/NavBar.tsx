				...
				{user ? (
					<>
						<button
							...
							className="flex justify-center text-xl size-12 text-primary-100 bg-primary-40 rounded-full items-center gap-1 mr-1 hover:bg-neutral-90 hover:text-neutral-0 cursor-pointer"
						>
							{getInitials(user)}
						</button>
						<Menu
