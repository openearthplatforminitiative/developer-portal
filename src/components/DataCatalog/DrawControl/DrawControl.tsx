	...
	return (
		<>
			...
			<div className="absolute bottom-0 p-4 w-full flex justify-center gap-2 pointer-events-none">
				<motion.div
					layout="position"
					className="w-min flex flex-row shadow-md rounded-lg pointer-events-auto"
				>
					<button
				...
				{selectedFeature && (
					<motion.div
						layout="position"
						className="absolute right-5 w-min flex flex-row shadow-md rounded-lg pointer-events-auto"
					>
