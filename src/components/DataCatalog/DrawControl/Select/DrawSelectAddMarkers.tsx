...
type DrawSelectAddMarkersProps = {
  onClick: (e: MarkerEvent<MouseEvent>, coordinate: [number, number], index: number) => void
  coords: [number, number][]
  featureToUpdate: GeoJSON.Feature
}

export const DrawSelectAddMarkers = ({ onClick, coords, featureToUpdate }: DrawSelectAddMarkersProps) => {
