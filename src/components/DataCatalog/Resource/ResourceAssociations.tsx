...
export const ResourceAssociations = ({
	resource,
}: ResourceAssociationsProps) => {
	if (
...
export const ResourceParents = ({ resource }: ResourceAssociationsProps) => {
	...
	const parents = Object.entries(titleToResourcesMap).map(
		([title, resources]) => ({
			title,
			resources,
		})
...
export const ResourceChildren = ({ resource }: ResourceAssociationsProps) => {
	...
	const children = Object.entries(titleToResourcesMap).map(
		([title, resources]) => ({
			title,
			resources,
		})
