	...
	return (
		<Box className="w-full h-full lg:max-w-7xl px-8 lg:my-44 my-20">
			...
			<Box className="flex flex-col gap-44 mb-96">
						...
						<Table>
							...
							<TableBody>
								...
								<TableRow>
									...
									<TableCell className="text-base">Create resources</TableCell>
								</TableRow>
								<TableRow>
								...
								<TableRow>
									...
									<TableCell className="text-base">Delete resources</TableCell>
								</TableRow>
							</TableBody>
						</Table>
					</TableContainer>
				...
				<Box>
					<Typography className="text-4xl">3. Third and final step</Typography>
